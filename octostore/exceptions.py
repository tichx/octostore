...
from octostore.mlflow.protos.databricks_pb2 import (
    INTERNAL_ERROR,
...
class OctostoreException(Exception):
    """
    ...
    def __init__(self, message, error_code=INTERNAL_ERROR, **kwargs):
        ...
        super(OctostoreException, self).__init__(message)
...
class RestException(OctostoreException):
...
class ExecutionException(OctostoreException):
    """Exception thrown when executing a project fails"""

    pass


class MissingConfigException(OctostoreException):
